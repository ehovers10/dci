...
{% include appendices/concept.html word='Discourse' %} can take a wide variety of forms, but academic study has been primarily concerned with the subclass of discourses that fall under the heading of *cooperative exchanges of information*.  These discourses involve two or more individuals engaged in a project of achieving the goal of increasing their mutual knowledge, using each other's stock of information to augment their own. In this form, discourse implements a jointly undertaken {% include appendices/concept.html word='inquiry.' %} An inquiry is, in the words of Robert Stalnaker, "the enterprise of forming, testing, and revising beliefs" {% include appendices/ref.html id="stalnaker1987" p='ix' e='.' %}

Discourse that implements a joint inquiry is {% include appendices/concept.html word='cooperative:' base='cooperation' %} A speaker presents some content in a way that makes room for responses that she anticipates her {% include appendices/concept.html word='interloctors' base='interlocutor' %} are able to provide. A hearer considers the contribution, adds it to her personal model of the conversation, and adjusts her response to accord with the expanded model. And the process iterates with the discourse participants alternating roles, always trying to make their contribution fit with what has predeeded it. Paul Grice took his *cooperative principle*, "make your conversational contribution such as is required, at the stage at which it occurs, by the accepted purpose or direction of the talk exchange in which you are engaged," to be the one general principle by which participants in conversations derive the import of their {% include appendices/concept.html word="interlocutors'" base='interlocutor' %} utterances {% include appendices/ref.html id="grice1989" o="n" e="." %} But discourse isn't just cooperative in this sense -- it is {% include appendices/concept.html word="collaborative." base='collaboration' %}
...
The principle departure point for the discussion is the speech act of {% include appendices/concept.html word='conjecture.' %} In the course of conversation, individuals will ocassionally put forward information for which they do not possess conclusive evidence. Sometimes, the basis for such a maneuver is laziness, deceit, or obstinance. But often, this kind of move is just what the conversation needs to move forward. For instance, in brainstorming sessions, the scientific context of discovery, or tip-of-the-tongue style paralysis, discurrsants set aside the restriction that all contributions be considered to be accurate in favor of entering into the {% include appendices/concept.html word='conversational record' base='common ground' %} something that the parties can use as a jumping off point. In these situations, speculative informational profferments form an important part in advancing the inquiry. 

At its base, this common conversational move, a {% include appendices/concept.html word='conjecture,' %} is a distinctive kind of {% include appendices/concept.html word='speech act' %} in which the speaker offers up her content with a {% include appendices/concept.html word='world-directed,' %} but less than {% include appendices/concept.html word='assertoric,' base='assertion' %} force. But a conjecture does not advance the inquiry on its own. Putting forward information one does not stand behind as accurate risks muddling the inquiry unless it is taken as merely a jumping off point. A conjecture *calls out* for a response, and the contribution it makes is not complete until that response is made. 

A conjecture needs to be vetted, and the canonical response to a conjecture is a move that provides this -- a {% include appendices/concept.html word="correction." %} Corrections can take many forms, but they normally involve two parts, a *denial* of some portion of the information previously put forward and a *substitution* for the denied information. The conjecture lays a rough foundation, and the correction builds upon it.

The dual conversational moves of conjecture and correction are what I call a {% include appendices/concept.html word='discourse pair.' %} The key precept of collaborative discourse dynamics is that discourse pairs are the basic units by which {% include appendices/concept.html word="contributions" base="contribution" %} to the inquiry are made. That is, we do not represent the conjecturer and corrector as each providing indvidually complete and jointly cooperative contributions to the discourse. Instead, the conjecture/correction pair together contribute to the inquiry; the parts are individually inert.

The project of using the notion of discourse pairs to develop and motivate a theory of collaborative {% include appendices/concept.html word='discourse dynamics' %} has 3 parts: 
...
> **[Theoretical](#theory):** Development of a deeply {% include appendices/concept.html word='collaborative' base='collaboration' %} account of discourse dynamics and a formal model of {% include appendices/concept.html word='conjectures' base='conjecture' %} and {% include appendices/concept.html word='corrections' base='correction' %} within the {% include appendices/concept.html word='update semantics' %} tradition.

> **[Practical](#practice):** Application of the collaborative framework to the phenomenon of {% include appendices/concept.html word='contrastive topic,' base='contrastive topic' %} implications of the collaborative model for the concept of linguistic {% include appendices/concept.html word='disagreement,' %} and the {% include appendices/concept.html word='contentualism' %} v. {% include appendices/concept.html word='relativism' %} debate in semantics.
...
Conjectures are best understood as one half of a pair of moves in a discourse. A contribution is incomplete without both parts being incorporated. In general, discourse pairs are completed by someone other than the one who initiates them {% include appendices/ref.html id="clark1986" o="n" e="." %} Thus, discourse pairs represent genuinely collaborative contributions to the inquiry, which can be fruitfully modeled within a natural extension to the {% include appendices/concept.html word='update semantics' %} framework.

Standard update semantics is build upon a system of sequential additions to and operations on a shared {% include appendices/concept.html word='discourse space.' base='common ground' %} By supplementing this framework with a middle ground working space, a discourse {% include appendices/concept.html word='sandbox,' %} we can represent interlocutors' joint contributions, decomposed into {% include appendices/concept.html word='initiation' %} and {% include appendices/concept.html word='completion' %} phases.
...
The primary goal of inquiry is to come to know something one did not know at its outset.[^Kitioi] Thus, an individual can advance us toward that goal by submitting (proposing) information to be taken on as mutually accepted. We call this kind of contribution an {% include appendices/concept.html word='assertion.' %}
...
But dispute can also be a fruitful tool for people involved in an honest, cooperative attempt to further mutual knowledge. There is the ancillary fact that interlocutors sometimes lose track of the cooperative effort, and it is valuable to have a means of correcting them to bring them back on to the task at hand.  But dispute can play also more central role in the project of inquiry. As we have seen, the speech act of correction, in which an individual denies a proposal initiated by an interlocutor is a crucial element in properly vetting conjectures in discourse. As such, some element of dispute is central to the enterprise of inquiry. I contend that the conjecture/correction discourse pair provides a genuine contribution to inquiry. In the previous chapter, I motivated this status by providing a model of discourse dynamics that carves out a distinctive operation on information that this contribution makes. In this chapter I explore another criterion for genuine contributions: that it be represented in some conventionalized linguistic tool. I think that this tool is {% include appendices/concept.html word="focus," %} and that the virtues of collaborative discourse dynamics come to prominence in explaining focus interpretation when we examine {% include appendices/concept.html word="contrastive topic" %} specifically.

Consider the following little discourse:

{% include examples/ex.html type="ex" sent="Bears are dangerous." sub="[Grizzly]<sub>cf</sub> bears are dangerous." link="bears" %}
...
{% include examples/ex.html type="ex" sent="The movie was funny." sub="The movie wasn't [funny]<sub>f</sub>, it was [hilarious]<sub>f</sub>." %}
