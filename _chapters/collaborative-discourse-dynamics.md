...
{% include examples/ex.html type="ex" term="Tense" sent="I didn't turn off the stove." sub="" defn="Obs/Def" %}
...
{% include examples/ex.html type="ex" term="Modality" sent="A wolf might walk into the house. It would eat you." sub="" defn="Obs/Def" %}
...
{% include examples/ex.html type="ex" term="Coherence" sent="Bill was about to be impeached. He called his lawyer." sub="? Bill was about to be impeached. He bought six pounds of zucchini." defn="Obs/Def" %}
...
The nature of the empirical data is itself up for debate, but it is widely accepted (and I will presume) that we can take language users' intuitions about {% include appendices/concept.html word='truth conditions' %} [cite TC intuitions], {% include appendices/concept.html word='anaphoric relations' %} {% include appendices/ref.html id="bittner2011" o="n" %}, and {% include appendices/concept.html word='illocutionary force' base='speech act' %} [cite force intuitions] as the data points our theory must account for.
...
{% include appendices/concept.html word='Update semantics' %} is a class of theories of conversational structure in which the conversational scoreboard is represented by a set-theoretic structure that we will refer to as the {% include appendices/concept.html word='information state.' %} {% include appendices/concept.html word='Discourse dynamics' %} is implemented by means of {% include appendices/concept.html word='updates' base='update' %}, which are operations on this structure.

Collaborative update semantics builds off of a standard update semantics. Following Sarah Murray {% include appendices/ref.html id="murray2014" %}, information states are *articulated* to account for different types of update that are relevant to discourse dynamics. One element is the {% include appendices/concept.html word='common ground,' %} a possibility space represented by a set of possible worlds considered to be ways the world could be according to what the conversational participants mutually take for granted. {% include appendices/concept.html word='Informative updates' base='informative update' %} place {% include appendices/concept.html word='conditions' base='condition' %} on the common ground. Formally, informative updates function by intersection of the common ground with the {% include appendices/concept.html word='content' %} of the utterance from which they stem. Informative updates are used to model the speech act of {% include appendices/concept.html word='assertion.' %}
...
{% include examples/ex.html type="ex" sent="[Sue danced]<sub>heard</sub>, and [Jim sang]<sub>saw</sub>." term="sing" %}
