...
<!-- Presidents -->
{% include ex2.html term="presidents" %}
...
<!-- Refinement -->
{% include ex.html type="def" term="refinement" defn=site.data.definitions.obs.refinement %}
...
<!-- Correction -->
{% include ex.html type="obs" term="correction" defn=site.data.definitions.obs.correction %}
...
<!-- Resiliance -->
{% include ex.html type="obs" term="resiliance" defn=site.data.definitions.obs.resiliance %}
...
<!-- Productivity -->
{% include ex.html type="obs" term="productivity" defn=site.data.definitions.obs.productivity %}
...
<!-- Susceptibility -->
{% include ex.html type="obs" term="susceptibility" sent="Example" sub="Sub-example" defn=site.data.definitions.obs.susceptibility %}
...
{% capture focussem %}
{% include eqn2.html term="focus" type="sem" %}
{% endcapture %}
{% include ex.html type="def" term="Focus semantic value" sent="Example" sub="Sub-example" defn=focussem %}
...
<!-- Cookie sem -->
{% include ex2.html term="cookie" type="sem" %}
...
<!-- QA-congruence -->
{% capture qacong %}
{% include eqn2.html term="qa-congruence" type="sem" %}
{% endcapture %}
{% include ex.html type="def" term="QA-Congruence" sent="Example" sub="Sub-example" defn=qacong %}
...
<!-- Picnic structure -->
{% include ex2.html term="picnic" type="extra" %}
...
<!-- DRS -->
{% capture drsstuff %}
{% include eqn2.html term="drs" type="sem" %}
{% endcapture %}
{% include ex.html type="def" term="DRS" sent="Example" sub="Sub-example" defn=drsstuff %}
...
<!-- Downdate -->
{% capture dd %}
{% include eqn2.html term="downdate" type="sem" %}
{% endcapture %}
{% include ex.html type="def" term="Downdate" sent="Example" sub="Sub-example" defn=dd %}
...
<!-- Managed -->
{% include ex2.html term="managed" type="sem" %}
...
<!-- Madrigals -->
{% include ex2.html term="madrigals" %}
...
<!-- Madrigals -->
{% include ex2.html term="madrigals" type="ldrt" %}
...
<!-- Spanish ldrt -->
{% include ex2.html term="spanish" type="ldrt" %}
...
{% capture strict %}
##### Translations
{% include eqn2.html genus="counterfactual conditional" term="strict" type="trans" %}
{% include eqn2.html genus="universal quantifier" term="strict" type="trans" %}

##### Semantics
{% include eqn2.html genus="counterfactual conditional" term="strict" type="sem" %}
{% include eqn2.html genus="universal quantifier" term="strict" type="sem" %}
{% endcapture %}
...
<!-- Thinning -->
{% capture thin %}
{% include eqn2.html genus="counterfactual conditional" term="thinning" type="sem" %}
{% endcapture %}
...
{% capture variably %}
##### Translation
{% include eqn2.html genus="counterfactual conditional" term="variable" type="trans" %}

##### Semantics
{% include eqn2.html genus="counterfactual conditional" term="variable" type="sem" %}
{% endcapture %}
{% include ex.html type="def" term="Variable strict" sent="Example" sub="Sub-example" defn=variably %}
...
{% capture shifty %}
##### Translation
{% include eqn2.html genus="counterfactual conditional" term="shifty" type="trans" %}

##### Semantics
{% include eqn2.html genus="counterfactual conditional" term="shifty" type="sem" %}
{% endcapture %}
{% include ex.html type="def" term="Shifty strict" sent="Example" sub="Sub-example" defn=shifty %}
...
<!-- Hibernation -->
{% include ex2.html term="hibernate" %}
...
{% capture generic %}
##### Translation
{% include eqn2.html genus="universal quantifier" term="generic" type="trans" %}

##### Semantics
{% include eqn2.html genus="universal quantifier" term="generic" type="sem" %}
{% endcapture %}
{% include ex.html type="def" term="Generic" sent="Example" sub="Sub-example" defn=generic %}
...
{% capture generic %}
##### Translation
{% include eqn2.html genus="universal quantifier" term="structural" type="trans" %}

##### Semantics
{% include eqn2.html genus="universal quantifier" term="structural" type="sem" %}
{% endcapture %}
{% include ex.html type="def" term="Structural" sent="Example" sub="Sub-example" defn=generic %}
...
<!-- Homogeneity -->
{% include ex.html type="def" term="Homogeneity" sent="Example" sub="Sub-example" defn=site.data.definitions.homogeneity.def %}
...
{% include eqn2.html genus="collaborative update" term="initiation" type="sem" %}

##### Continuation utterance
{% include eqn2.html genus="collaborative update" term="continuation" type="sem" %}

##### Completion utterance
{% include eqn2.html genus="collaborative update" term="completion" type="sem" %}
