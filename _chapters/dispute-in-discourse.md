...
I contend that the conjecture/correction discourse pair provides a genuine contribution to inquiry. In the previous chapter, I motivated this status by providing a model of discourse dynamics that carves out a distinctive operation on information that this contribution makes. In this chapter I explore another criterion for genuine a contribution: that it be represented in some conventionalized linguistic tool. I think that this tool is {% include appendices/word.html word="focus," %} and that the virtues of collaborative discourse dynamics come to prominence in explaining focus interpretation when we examine {% include appendices/word.html word="contrastive topic" %} specifically.
...
In the remainder of this paper, I examine two extant proposals in the literature and contend that neither captures these observations in their entirety. My preferred analysis is based upon the collaborative update framework, supplementing it with an analysis of {% include appendices/word.html word="bare plurals." base="" e="" %}

# Correction as contrastive topic

A salient feature of the [Bears](#bears) dialogue is the presence of {% include appendices/word.html word="focus" %} on *grizzly* in the completion. Focus is a lingusitic tool whose use serves primarily to *package* information carried by other components. For instance, focus can be be used to divide the informational content of an utterance into that which is assumed to be part of the common ground and that which is newly contributed {% include appendices/ref.html id="jackendoff1972" o="n" e="." %} The virtue of information packaging is in aiding uptake for the other participants in the discourse by showing them how the contribution is intended to fit with what has preceeded.
...
A {% include appendices/word.html word="database" base="" e="" %} is a collection of data structured by a series of {% include appendices/word.html word="tables" base="table" e="" %}
that represent interrelations among the points of data. The information contained in a database can be manipulated in a variety of ways principal among which is the {% include appendices/word.html word="query," base="" e="" %} which pulls specific information from one or more tables, packaging it into a {% include appendices/word.html word="view" base="" e="" %}, itself a table in form, but a mere image of the underlying database. Views allow the user to access and make use of data without impacting the underlying structure of the database.

A {% include appendices/word.html word="relational algebra" base="" e="" %} extends standard set theoretic operations with a set of operations on tables and provides a means of representing manipulations of structured data in a neat way {% include appendices/ref.html id="codd1970" o="n" e="." %} For the purposes of representing the discourse evolution of disputative dialogue involving plural predication, we add a subset of the relational algebra framework to collaborative update. Namely, we co-opt operations of: {% include appendices/word.html word="projection" base="" e="," %} {% include appendices/word.html word="outer join" base="" e="," %} {% include appendices/word.html word="grouping" base="group" e="," %} {% include appendices/word.html word="counting" base="count" e="," %} and {% include appendices/word.html word="renaming" base="rename" e="." %}
